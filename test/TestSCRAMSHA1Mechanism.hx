...
class TestSCRAMSHA1Mechanism extends utest.Test {
	...
	function test_createChallengeResponse() {
		...
		var serverMessage = Base64.decode( 'cj1mNjNmYTIyZTRhY2NmNzJhYjkxYjJiNTlhZjgzYzU0NTQ3ZTg0N2Q2LWUzOTgtNDA5ZC05OGRlLWZhNjI1MmU2ZjI5ZixzPTVqWjkvR2V4U1MzZkRwNC9QUVRjU0wwMWtaUlVSYTNILGk9NDA5Ng==' ).toString();
